...
halo_name = '10c'
halo_cen = np.asarray([10940.425, 14202.184, 11710.072])
r_half = 0.35
...
plt.scatter(star_xyz[:,0], star_xyz[:,1])
...
save_fig_file = base1 + 'ab_ratios/'+str(halo_name)+'.txt'

np.savetxt(save_fig_file, ab_ratio)

print 'saved: '+ str(save_fig_file)
